  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", fontFamily:"'DM Sans',sans-serif", overflow:"hidden" }}>
      ...
      <div className="auth-left" style={{
        ...
        padding:"-50px 30px 30px 30px", position:"relative", overflow:"hidden",
      }}>
        ...
        <div style={{ animation:"authFadeUp 0.6s 0.1s ease both" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
            {[
              { icon:"🕌", text:"Umrah & Travel Packages"    },
              { icon:"📋", text:"Customer Inquiry Tickets"   },
              { icon:"✍️", text:"Blog & Content Management"  },
              { icon:"👥", text:"Team & User Management"     },
            ].map(f => (
              <div key={f.text} style={{ display:"flex", alignItems:"center", gap:12 }}>
                <div style={{ width:32, height:32, borderRadius:10, background:"rgba(255,255,255,0.1)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:15, flexShrink:0 }}>{f.icon}</div>
